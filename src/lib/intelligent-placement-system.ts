...
The furniture must appear professionally wall-mounted with appropriate hardware and no floor connection.`;
   ...
   */
  private static buildFloorStandingConstraints(productType: string, level: string): string {
...
• Position within realistic interior space context`;
   ...
   */
  private static buildTabletopConstraints(productType: string, level: string): string {
...
• Supporting surface integral to composition`;
   ...
   */
  private static buildCeilingMountedConstraints(productType: string, level: string): string {
...
• Realistic clearances and spatial relationships`;
   ...
   */
  private static buildBuiltInConstraints(productType: string, level: string): string {

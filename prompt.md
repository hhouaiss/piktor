...
Create a professional product packshot image for our ecommerce website of our main product in the images and follow strictly the instructions included in the json profile below: {"meta":{"format":"packshot","platform":"ecommerce_catalog","use_case":"ecommerce_product_image","generated_at":"2025-08-12T08:20:24.610Z","version":"2.0","generation_method":"images_edits_with_reference"},"product":{"name":"modern Wall mounted desk","type":"Wall mounted desk","materials":"birch plywood, black laminate, nylon straps, metal screws","primary_color":"#4A4A4A","style":"modern","dimensions":{"width":80,"height":40,"depth":5,"unit":"cm"},"key_features":["foldable desk","integrated storage compartments","birch plywood construction"],"all_features":[{"name":"foldable desk","description":"The desk folds down to provide a workspace and folds up to save space.","importance":"high"},{"name":"integrated storage compartments","description":"Multiple compartments for organizing small items like notebooks, gadgets, and stationery.","importance":"high"},{"name":"nylon support straps","description":"Durable black nylon straps support the desk when unfolded.","importance":"medium"},{"name":"rounded edges","description":"Smooth, rounded edges for a sleek appearance and safety.","importance":"medium"},{"name":"birch plywood construction","description":"Made from durable birch plywood with visible layers on the edges.","importance":"high"}]},"visual_requirements":{"context_preset":"packshot","background_style":"lifestyle","lighting_setup":"warm ambient","product_position":"center","image_dimensions":"1024x1024","quality_level":"high","strict_mode":true,"props_allowed":[],"reserved_text_zone":null},"photography_specs":{"cameraAngle":"eye-level, slightly angled to show depth","lightingSetup":"soft diffused key light from above, fill light from the side, subtle rim light for edge definition","depthOfField":"shallow depth of field to focus on the desk surface and compartments","composition":"rule of thirds, leading lines from the straps, balanced visual weight"},"material_details":{"materialTextures":"The charcoal gray laminate has a smooth, matte finish with subtle grain patterns. The birch plywood edges show natural wood layers, adding texture and warmth.","colorPalette":"Charcoal gray with natural wood undertones. Highlights are soft and warm, while shadows are deep and cool.","hardwareDetails":"Metal screws with a brushed finish secure the nylon straps. The straps are tightly woven for durability.","proportionalRelationships":"The desk surface is proportionally larger than the storage compartments, providing ample workspace. The compartments are evenly spaced for balanced organization."},"context_specific":{"background":"lifestyle","lighting":"warm ambient","product_position":"center","style":"Clean professional product photography","background_requirement":"Minimal, non-distracting background","lighting_requirement":"Even studio lighting with no harsh shadows","composition_requirement":"Product centered, fills appropriate portion of frame","focus_requirement":"Product in sharp focus throughout","context":"E-commerce catalog presentation"},"output_specifications":{"format":"PNG","quality":"maximum","color_profile":"sRGB","compression":"lossless","background_handling":"auto","moderation":"auto"},"constraints":{"no_text_overlay":true,"no_watermarks":true,"no_logos":true,"maintain_product_fidelity":true,"respect_aspect_ratio":true,"commercial_use":true}}